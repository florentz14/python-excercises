# -------------------------------------------------
# File Name: Baez_Module_01_07_turtle_shapes.py
# Author: Florentino Báez
# Date: Module 01 Lab - Exercise 7
# Description: Drawing Shapes with Turtle.
#              Use the turtle module to draw basic shapes (circle,
#              triangle, square) with different colors and positions.
# -------------------------------------------------
