# ---------------------------------------------------------------------------
# Sets - 03: Add Set Items
# ---------------------------------------------------------------------------
# Description: Add items to a set using add() for a single item or
#              update() to add multiple items from any iterable.
# Methods:     set.add(item)       -> add one item
...
# =========================================================================
# Practical example: collect unique tags
# =========================================================================
