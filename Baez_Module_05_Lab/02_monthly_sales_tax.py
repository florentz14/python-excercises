...
if __name__ == "__main__":
    ...
    try:
        ...
        if total_sales < 0:
            ...
            county_tax = calculate_county_sales_tax(
                total_sales, COUNTY_TAX_RATE)
            ...
            print(
                f"County Sales Tax ({COUNTY_TAX_RATE * 100}%): ${county_tax:,.2f}")
            print(
                f"State Sales Tax ({STATE_TAX_RATE * 100}%): ${state_tax:,.2f}")
