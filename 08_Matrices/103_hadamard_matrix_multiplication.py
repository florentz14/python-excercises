# -------------------------------------------------
# File Name: 103_hadamard_matrix_multiplication.py
# Author: Florentino Baez
# Date: 2026-03-09
# Description: Element-wise matrix multiplication (Hadamard product).
# -------------------------------------------------
...
if __name__ == "__main__":
    ...
    print(SEPARATOR)
    print("  MATRIX MULTIPLICATION (Hadamard)")
    print(SEPARATOR)
    ...
    print_matrix(matrix_c, "Result C = A * B (element-wise)")
