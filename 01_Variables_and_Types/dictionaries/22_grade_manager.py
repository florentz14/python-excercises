...
class GradeManager:
    ...
    def add_grade(self, student_id, subject, grade):
        ...
        print(
            f"✓ Added {subject} grade ({grade}) for {self.students[student_id]['name']}")
        return True
    ...
    def get_class_statistics(self):
        ...
        for student_id, student_data in self.students.items():
            ...
            if avg is not None and avg > 0:  # Only include students with recorded grades
        ...
        for student_id, student_data in self.students.items():
            ...
            if avg is not None and avg > 0:  # Only include students with recorded grades
                ...
                student_averages.append(
                    (student_data["name"], avg, student_id))
