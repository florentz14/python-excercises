# ------------------------------------------------------------
# File: 49_transport_analysis.py
# Purpose: Transport/travels analyzer - routes, times, costs, delays.
# Description: Avg time per route, trips by driver, total cost, frequent delays.
# ------------------------------------------------------------
