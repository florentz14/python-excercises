# ------------------------------------------------------------
# File: 41_student_attendance.py
# Purpose: Student attendance system - absences, punctuality, risk.
# Description: to_datetime, count attendance, % attendance, at-risk students.
# ------------------------------------------------------------
...
CSV_PATH = Path(__file__).parent / "data" / "student_attendance.csv"
