# ------------------------------------------------------------
# File: 43_inventory_dashboard.py
# Purpose: Inventory dashboard - stock, inputs/outputs, reorder.
# Description: merge, reorder detection, turnover, most moved products.
# ------------------------------------------------------------
...
MOVEMENTS_PATH = Path(__file__).parent / "data" / "inventory_movements.csv"
STOCK_PATH = Path(__file__).parent / "data" / "inventory_stock.csv"
