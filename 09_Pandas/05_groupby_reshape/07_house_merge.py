# -------------------------------------------------
# File Name: 34_house_merge.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: 3-table merge of listings, neighborhoods, sales; NaN detection, price analysis.
# -------------------------------------------------
...
df_listings = pd.read_csv(Path(__file__).parent.parent / "data" / "house_listings.csv")
df_neighborhoods = pd.read_csv(Path(__file__).parent.parent / "data" / "house_neighborhoods.csv")
df_sales = pd.read_csv(Path(__file__).parent.parent / "data" / "house_sales.csv")
