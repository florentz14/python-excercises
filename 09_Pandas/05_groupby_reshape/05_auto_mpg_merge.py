# -------------------------------------------------
# File Name: 32_auto_mpg_merge.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Inner/left/right/outer joins with auto MPG and origin data.
# -------------------------------------------------

import pandas as pd
from pathlib import Path

df_cars = pd.read_csv(Path(__file__).parent.parent / "data" / "auto_mpg_cars.csv")
df_origin = pd.read_csv(Path(__file__).parent.parent / "data" / "auto_mpg_origin.csv")
