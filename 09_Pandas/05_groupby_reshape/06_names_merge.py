# -------------------------------------------------
# File Name: 33_names_merge.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Multi-key merge, concat, indicator with personal/work/education data.
# -------------------------------------------------

import pandas as pd
from pathlib import Path

df_personal = pd.read_csv(Path(__file__).parent.parent / "data" / "fictitious_personal.csv")
df_work = pd.read_csv(Path(__file__).parent.parent / "data" / "fictitious_work.csv")
df_education = pd.read_csv(Path(__file__).parent.parent / "data" / "fictitious_education.csv")
