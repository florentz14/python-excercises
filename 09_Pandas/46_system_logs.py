# ------------------------------------------------------------
# File: 46_system_logs.py
# Purpose: System logs analyzer - errors, patterns, severity.
# Description: read logs, search patterns, count errors, filter by date/severity.
# ------------------------------------------------------------
...
CSV_PATH = Path(__file__).parent / "data" / "system_logs.csv"
