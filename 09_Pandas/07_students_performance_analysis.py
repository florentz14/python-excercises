# ------------------------------------------------------------
# File: 07_students_performance_analysis.py
# Purpose: Students Performance CSV Analysis.
# Description: Loads StudentsPerformance.csv, descriptive stats,
#              averages by gender, lunch, test prep, parental education.
#              Computes global average score column.
# ------------------------------------------------------------
