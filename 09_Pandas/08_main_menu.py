# ------------------------------------------------------------
# File: 08_main_menu.py
# Purpose: Master Analysis Menu (Interactive).
# Description: Interactive menu that runs all analysis scripts via subprocess.
#              Options: individual analyses (1-6), run all (7), or exit.
# ------------------------------------------------------------
...
def run_all():
    ...
    programs = [
        ...
        ("02_parental_education_analysis.py", "Parental Education Analysis"),
        ("06_test_preparation_analysis.py", "Test Preparation Analysis"),
        ("01_lunch_analysis.py", "Lunch Type Analysis"),
        ("04_ethnic_group_analysis.py", "Ethnic Group Analysis"),
    ]
...
def main():
    ...
    options = {
        ...
        "3": ("02_parental_education_analysis.py", "Parental Education Analysis"),
        "4": ("06_test_preparation_analysis.py", "Test Preparation Analysis"),
        "5": ("01_lunch_analysis.py", "Lunch Type Analysis"),
        "6": ("04_ethnic_group_analysis.py", "Ethnic Group Analysis"),
    }
