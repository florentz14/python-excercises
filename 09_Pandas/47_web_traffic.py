# ------------------------------------------------------------
# File: 47_web_traffic.py
# Purpose: Web traffic analyzer - visits, pages, sessions, conversions.
# Description: timestamps, group by day/week/month, sessions, conversion rate.
# ------------------------------------------------------------
...
CSV_PATH = Path(__file__).parent / "data" / "web_traffic.csv"
