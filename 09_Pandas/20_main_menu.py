...
def run_all():
    ...
    programs = [
        ("15_general_analysis.py", "General Analysis"),
        ("17_gender_analysis.py", "Gender Analysis"),
        ("14_parental_education.py", "Parental Education Analysis"),
        ("18_test_preparation.py", "Test Preparation Analysis"),
        ("13_lunch_analysis.py", "Lunch Type Analysis"),
        ("16_ethnic_group.py", "Ethnic Group Analysis"),
    ]
...
def main():
    ...
    options = {
        "1": ("15_general_analysis.py", "General Analysis"),
        "2": ("17_gender_analysis.py", "Gender Analysis"),
        "3": ("14_parental_education.py", "Parental Education Analysis"),
        "4": ("18_test_preparation.py", "Test Preparation Analysis"),
        "5": ("13_lunch_analysis.py", "Lunch Type Analysis"),
        "6": ("16_ethnic_group.py", "Ethnic Group Analysis"),
    }
