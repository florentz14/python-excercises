# -------------------------------------------------
# File Name: 30_alcohol_apply.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Uses apply, map, lambda, and custom functions with risk flags.
# -------------------------------------------------

import pandas as pd
from pathlib import Path

csv_path = Path(__file__).parent.parent / "data" / "students_alcohol.csv"
