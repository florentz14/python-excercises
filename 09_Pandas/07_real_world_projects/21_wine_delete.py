# -------------------------------------------------
# File Name: 47_wine_delete.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Outlier removal, select_dtypes, fillna vs dropna on wine quality.
# -------------------------------------------------
...
# -------------------------------------------------
df = pd.read_csv(Path(__file__).parent.parent / "data" / "wine_quality.csv")
