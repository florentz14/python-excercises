# -------------------------------------------------
# File Name: 31_crime_rates_apply.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Per-capita rates, pct_change, and normalization.
# -------------------------------------------------

import pandas as pd
from pathlib import Path

df = pd.read_csv(Path(__file__).parent.parent / "data" / "us_crime_rates.csv")
