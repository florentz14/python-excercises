# -------------------------------------------------
# File Name: 48_sales_analysis.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Finds best product, best month, top customer from store sales.
# -------------------------------------------------
...
CSV_PATH = Path(__file__).parent.parent / "data" / "store_sales.csv"
