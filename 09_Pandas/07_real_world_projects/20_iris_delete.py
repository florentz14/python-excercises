# -------------------------------------------------
# File Name: 46_iris_delete.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Uses drop, dropna, del, pop, drop_duplicates on Iris dataset.
# -------------------------------------------------
...
# -------------------------------------------------
df = pd.read_csv(Path(__file__).parent.parent / "data" / "iris.csv")
