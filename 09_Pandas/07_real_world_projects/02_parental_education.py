# -------------------------------------------------
# File Name: 14_parental_education.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Analyzes impact of parental education level on student performance.
# -------------------------------------------------
...
if __name__ == "__main__":
    ...
    csv_path = Path(__file__).parent.parent / "data" / "StudentsPerformance.csv"
