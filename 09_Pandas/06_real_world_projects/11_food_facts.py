# -------------------------------------------------
# File Name: 23_food_facts.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Explores food nutrition data: nulls, missing %, data quality.
# -------------------------------------------------
...
csv_path = Path(__file__).parent.parent / "data" / "world_food_facts.csv"
