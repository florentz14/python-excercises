# -------------------------------------------------
# File Name: 22_occupation_explore.py
# Author: Florentino Báez
# Date: 09_Pandas
# Description: Explores user demographics: unique occupations, age stats.
# -------------------------------------------------
...
csv_path = Path(__file__).parent.parent / "data" / "occupation_users.csv"
