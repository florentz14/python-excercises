# ------------------------------------------------------------
# File: 04_ethnic_group_analysis.py
# Purpose: Ethnic Group Performance Analysis.
# Description: Compares performance across ethnic groups: rankings,
#              gaps, grade distribution, parental education, gender.
# ------------------------------------------------------------
